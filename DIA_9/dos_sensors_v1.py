...
# Configura el guany (ajusta segons el rang del sensor, aquí ±6.144V)
GAIN = 1  # ±4.096V
...
def read_sensors():
    ...
    return water_level, soil_moisture

def main():
    while True:
        # Llegeix els sensors
        soil_voltage, water_voltage = read_sensors()

        # Mostra els resultats
        print(f"Water Level Voltage: {water_voltage:.3f} V")
        print(f"Soil Moisture Voltage: {soil_voltage:.3f} V")
        print("-" * 30)
